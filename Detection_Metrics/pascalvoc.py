...
def get_map(file_tag="*.txt", folder_gt="groundtruths", folder_pred="detections", IOU_threshold=0.5):
    ...
    #                     default=os.path.join(currentPath, folder_gt),
    #                     metavar='',
    #                     help='folder containing your ground truth bounding boxes')
    # parser.add_argument('-det',
    #                     '--detfolder',
    #                     dest='detFolder',
    #                     default=os.path.join(currentPath, folder_pred),
    #                     metavar='',
